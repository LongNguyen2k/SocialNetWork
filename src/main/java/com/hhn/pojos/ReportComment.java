...
public class ReportComment implements Serializable{
    ...
    @ManyToOne
    @JoinColumn(name = "comment_report")
    private Comments commentsReport;
    ...
    public Comments getCommentsReport() {
        return commentsReport;
    }

    public void setCommentsReport(Comments commentsReport) {
        this.commentsReport = commentsReport;
    }
