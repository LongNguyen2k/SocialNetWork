<%-- 
    Document   : formSendReport
    Created on : Sep 28, 2021, 8:54:13 PM
    Author     : Windows 10
--%>
...
<c:url value="/user/sendReport" var="SendReport" />
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <c:if test="${errMsG != null}">
                 ...
                 <form:form method="post" modelAttribute="ReportPost" action="${SendReport}" cssClass="form-horizontal" cssStyle="background-color: white;" enctype="multipart/form-data"  >
            <fieldset>
                <legend class="text-center" style="font-weight: bold"><spring:message code="label.ReportLabelMainPost" /></legend>
            ...
            <div class="form-group">
                <form:input type="hidden" path="postReport" value="${postSelectedReport}" />
                  <form:errors path="postReport" cssClass="text-danger"  />     
            </div>
