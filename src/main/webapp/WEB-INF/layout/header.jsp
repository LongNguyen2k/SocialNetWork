...
<header>
    ...
    <c:url value="/profile" var="profilePage"/>
        <div>
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <form class="navbar-form navbar-left" action="" >
                            <div class="input-group" style="display: inline;">
                                <input type="text" name="kw" class="form-control" placeholder="Search this blog">
                        ...
                        <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Category<span class="caret"></span></a>
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    <c:forEach var="cat" items="${categories}">
                                        ...
                                        <li  role="presentation"><a  href="<c:url value="/postByCategoryPost/?catPostId=${cat.id}" />">${cat.name}</a></li>
                                    </c:forEach>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">User <span class="caret"></span></a>
                                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                    <li role="presentation"><a href="${profilePage}">My Profile</a></li>
